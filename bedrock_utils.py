...
def generate_response(prompt, model_id, temperature=0.7, top_p=0.9, kb_results=None):
    """
    Generate a model response using Bedrock. Optionally include KB results in the context.
    """
    try:
        context = ""
        if kb_results:
